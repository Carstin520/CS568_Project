...
# 创建或加载 Assistant
def create_assistant(name="Assistant", instructions="You are a helpful assistant.", model="gpt-4-turbo", tools=None, files=None, debug=False):
    """
    ...
    Args:
        ...
        model (str, optional): The model to use for the assistant. Defaults to ""gpt-4-turbo"".
        ...
        with open(assistant_file_path, "r") as file:
            ...
            for assistant_data in assistant_json:
                ...
                if assistant_name == name:
                    ...
                    print("loading existed Assistant ID ...")
                    if debug:
    ...
    with open(assistant_file_path, "w", encoding="utf-8") as file:
        ...
        print("Successfully saved Assistant information")
